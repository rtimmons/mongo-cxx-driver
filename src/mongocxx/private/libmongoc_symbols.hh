...
MONGOCXX_LIBMONGOC_SYMBOL(collection_create_bulk_operation)
...
MONGOCXX_LIBMONGOC_SYMBOL(collection_get_session)
...
MONGOCXX_LIBMONGOC_SYMBOL(database_get_session)
...
MONGOCXX_LIBMONGOC_SYMBOL(session_destroy)
MONGOCXX_LIBMONGOC_SYMBOL(session_get_collection)
MONGOCXX_LIBMONGOC_SYMBOL(session_get_database)
MONGOCXX_LIBMONGOC_SYMBOL(session_get_opts)
